...
\multicolumn{2}{r}{\large{Edition 0.2.10}}\\
\multicolumn{2}{r}{\large{31 December 2009}}
\end{tabular}
...
\cmidrule(r){2-3}
& \multicolumn{2}{p{\defnwidth}}{
  Returns $integer$ modulo $numeric$. $numeric$ can be an instance of $GMP::Z$, $Fixnum$,
  or $Bignum$. The return object's class is always $GMP::Z$.
}
\end{tabular}

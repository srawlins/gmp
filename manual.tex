...
\cmidrule(r){2-3}
& \multicolumn{2}{p{\defnwidth}}{
  Returns the ceiling division of $integer$ by $numeric$. $numeric$ can be a member of
...
& \multicolumn{2}{p{\defnwidth}}{
  ...
  be a member of $GMP::Z$, $Fixnum$, $Bignum$. The return object's class is always
  $GMP::Z$.
}
\end{tabular}
\newline\newline
...
\begin{tabular}{p{\methwidth} l r}
\toprule
\textbf{nextprime} & & $integer$.nextprime $\rightarrow$ $prime$ \\

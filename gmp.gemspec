Gem::Specification.new do |s|
  ...
  s.files += ["test/README", "test/tc_cmp.rb", "test/tc_fib_fac_nextprime.rb", "test/tc_q.rb",
              "test/tc_q_basic.rb", "test/tc_sgn_neg_abs.rb", "test/swap.rb", "test/tc_z.rb",
              "test/tc_z_basic.rb", "test/tc_z_exponentiation.rb", "test/tc_z_logic.rb",
              "test/tc_z_to_d_to_i.rb", "test/tc_zerodivisionexceptions.rb", "test/test_helper.rb",
              "test/unit_tests.rb"]
